...
<body>
    ...
    <section>
        ...
        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='phone' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="container mt-5 my-section">
            <h3 class="py-4">Computer</h3>
            <div class="row">

                <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='computer' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
        ...
        <div class="container mt-5 my-section">
            <h3 class="py-4">Electronics</h3>
            <div class="row">

                <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='electronics' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
        ...
        <!-- end here electronics -->


        <div class="container mt-5 my-section">
            <h3 class="py-4">Watch</h3>
            <div class="row">

                <?php

        // FECTH PRODUCTS
        $sql = "SELECT * from products WHERE category='watch' ORDER BY RAND() LIMIT 4";
        $query = $db->prepare($sql);
        $query->execute();
        $results = $query->fetchAll(PDO::FETCH_OBJ);
